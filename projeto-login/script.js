  const usuarioCadastrado = {username:"Larissard",password:"lari123", cpf:"999"}
  const usuarioCadastrado2 = {username:"Admin",password:"admin", cpf:"999"}
  const usuarioCadastrado3 = {username:"Usuario",password:"user", cpf:"999"}
